...
namespace Rivet {
  ...
  public:
    ...
    void init() {
	  ...
	  ptbins = get_ptbins("/data/horse/ws/maml087d-workspace/rivet_anas/data/inclusive/ptbins.txt");
	  coeffs = get_coeffs("/data/horse/ws/maml087d-workspace/rivet_anas/data/inclusive/histo_nocutscoeffs.txt", static_cast<int>(ptbins.size()));
	  // coeffs_of = get_coeffs_of("/data/horse/ws/maml087d-workspace/rivet_anas/data/inclusive/histo_nocutscoeffs_of.txt");
