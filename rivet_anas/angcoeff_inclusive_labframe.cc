...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      init_data(bins);
      save_pt(ptbins, "data/labframe/inclusive/ptbins.txt");
...
//	std::cout << "-----------------------------------------------" << std::endl << std::endl;
	...
	phi = p_l.phi();
      ...
      double Zcent, pTj1, pTj2, pTgj, pTll, mll, Dyjj, mjj, Dphijj, pTbal, cos_theta, phi, theta;
      size_t Nj, Ngj;
    ...
    Histo1DPtr _hist1, _hist2, _hist4, _hist_of1D_cos, _hist_of1D_phi, _hist_of1D_xsec;
