...
namespace Rivet {
  ...
  public:
    ...
    void init() {
	  ...
	  ptbins = get_ptbins("/data/horse/ws/maml087d-workspace/rivet_anas/data/labframe/inclusive/ptbins.txt");
	  coeffs = get_coeffs("/data/horse/ws/maml087d-workspace/rivet_anas/data/labframe/inclusive/histo_nocutscoeffs.txt", static_cast<int>(ptbins.size()));
	  // coeffs_of = get_coeffs_of("/data/horse/ws/maml087d-workspace/rivet_anas/data/labframe/inclusive/histo_nocutscoeffs_of.txt");
	  coeffs_of = {1,1,1,1,1,1,1,1,1};
...
//    }
    ...
    private:
      ...
      Histo1DPtr _hist1, _hist2, _hist4;
